...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en crear una ventana para editar el perfil de una cuenta.
    ...
    <body>
        <div class="general">
            <div class="cuadroIzquierdo">
                ...
                <p id="parrafoIntruccion">Editar tu cuenta de perfil es <span> gratuito </span> y puedes realizarlo todas las veces que puedas.</p>
                <p id="parrafoIntruccion">Para cambiar la descripción de su cuenta debe de cumplir una serie de requisitos: </p>
                <ul>
                    <li>Alfanumérico de hasta 255 caracteres.</li>
                </ul>
            </div>
            <div class="codigophp">
                <h1>Editar Perfil</h1>
